...
class DictionaryService {
  ...
  static const Set<String> _commonWords = {
    ...
    '早上', '今年', '去年', '明年', '前年', '什么', '不能', '不要',
    '觉得', '准备', '出现', '表示', '使用', '利用', '具有', '取得',
    '获得', '受到', '产生', '引起', '导致', '使得', '有没有', '是不是',
    '能不能', '会不会', '可不可以', '为什么', '怎么样', '什么样', '什么时候', '什么地方',
    '多少', '几个', '一点', '不一样', '不需要', '不可能', '不得不', '不在乎',
    '不像话', '不得了', '了不起', '来不及', '来得及', '对不起', '看起来', '看上去',
    '想起来', '说不定', '说不上', '说不清', '差不多', '差得远', '事实上', '实际上',
    '基本上', '大部分', '小部分', '一方面', '另一方面', '也就是说', '换句话说', '不仅仅是',
    '不仅仅', '不但不', '不但还', '既然是', '之所以', '是因为', '难道说', '要不然',
    '要不是', '恨不得', '巴不得', '说到底', '到底是', '到底有', '到底没', '一心一意',
    '三心二意', '四面八方', '五颜六色', '七上八下', '千变万化', '千山万水', '千方百计', '千家万户',
    '千军万马', '千言万语', '千真万确', '千辛万苦', '千奇百怪', '千姿百态', '千丝万缕', '千头万绪',
    '千差万别', '千锤百炼', '千篇一律', '各种各样', '各式各样', '多姿多彩', '多才多艺', '无忧无虑',
    '无法无天', '无边无际', '无穷无尽', '无影无踪', '无微不至', '自言自语', '自以为是', '自由自在',
    '自始至终', '自力更生', '不知不觉', '不慌不忙', '不约而同', '不可思议', '不可一世', '不以为然',
    '不由自主', '不言而喻', '不甘示弱', '不屈不挠', '大公无私', '大同小异', '大惊小怪', '大显身手',
    '大开眼界', '天长地久', '天翻地覆', '天经地义', '天衣无缝', '天南地北', '东张西望', '东奔西走',
    '东拉西扯', '东拼西凑', '南辕北辙', '前因后果', '前赴后继', '空前绝后', '思前想后', '承前启后',
    '左思右想', '左邻右舍', '左右为难', '左右逢源', '旁若无人', '风和日丽', '风平浪静', '风起云涌',
    '风调雨顺', '风雨同舟', '花言巧语', '花天酒地', '花花世界', '鸟语花香', '走马观花', '画龙点睛',
    '画蛇添足', '纸上谈兵', '指手画脚', '胸有成竹', '守株待兔', '掩耳盗铃', '亡羊补牢', '对牛弹琴',
    '刻舟求剑', '实事求是', '与时俱进', '科学发展', '社会和谐', '人民幸福', '中华民族', '伟大复兴',
    '中国梦', '社会主义', '改革开放',
  };
