...
class TestImports:
    ...
    def test_import_engine_mode(self) -> None:
        """EngineMode 枚举值正确。"""
        from writefont.pipeline import EngineMode
    ...
    def test_import_pipeline_result(self) -> None:
        ...
        from writefont.pipeline import PipelineResult
    ...
    def test_import_ocr(self) -> None:
        """OCR 模块可以导入。"""
        from writefont.ocr import OCREngine, OCRResult, RecognizedChar
...
class TestCharset:
    ...
    def test_get_ascii_chars(self) -> None:
        """ASCII 字符集包含 95 个字符。"""
        from writefont.utils.charset import get_ascii_chars
...
class TestPipeline:
    ...
    def test_pipeline_demo_mode(self) -> None:
        ...
        try:
            ...
            # 使用 demo provider 测试
            from writefont.pipeline import DemoProvider
            demo = DemoProvider()
...
class TestStyleTransformer:
    ...
    def test_style_transformer_init(self) -> None:
        ...
        from writefont.pipeline import StyleTransformer
...
class TestHandwritingFeatures:
    ...
    def test_total_dim(self) -> None:
        """总维度为 200。"""
        from writefont.style.features import HandwritingFeatures
...
class TestFontPackager:
    ...
    def test_export_ttf(self) -> None:
        """能导出 TTF 文件。"""
        from writefont.font.packager import FontPackager
        from writefont.font.vectorizer import Contour, ContourPoint
        import numpy as np
